...
class ScraperTests(unittest.TestCase):
    ...
    def test_weekly_article_groups_only_home_matches_at_pierre_albouy(self) -> None:
        ...
        self.assertIn("2 interclubs ce vendredi 4 septembre à la salle Pierre Albouy", article.content)
        self.assertIn("Un interclub ce dimanche 6 septembre à la salle Pierre Albouy", article.content)
